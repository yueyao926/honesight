  ...
  return (
    <section className="animate-fade-up">
      ...
      <PracticeDrawnCard
        ...
        art={
          <img
            src={standingCharacterSvg}
            alt=""
            aria-hidden="true"
            draggable={false}
            className="practice-drawn-card-character"
          />
        }
      >
        {mode === "improve" ? (
...
export default function Practice() {
  ...
  if (loading) return <main className="handwriting-page container-page"><div className="card animate-pulse text-sm text-muted">正在准备每周一练…</div></main>;
