...
export default function Practice() {
  ...
  if (loading) return <main className="container-page"><div className="card animate-pulse text-sm text-muted">正在准备每周训练计划…</div></main>;
  ...
  return (
    <main className="container-page max-w-5xl">
      <header className="mb-8 animate-fade-up">
        ...
        <h1 className="page-title mt-2">本周训练计划</h1>
        <p className="mt-3 text-base text-muted">主练完成即可达成本周目标，选练按你的时间自由添加。</p>
      </header>
