...
export default function PracticeReplace() {
  ...
  const replaceSession = sessions.find((item) => item.id === Number(sessionId)) || null;
  ...
  return (
    <main className="handwriting-page practice-page container-page max-w-5xl">
      ...
      <header className="mt-6 mb-6 animate-fade-up">
        <p className="section-eyebrow">{formatWeekLabel(overview?.week_key)}</p>
        <div className="mt-2 flex items-start justify-between gap-4">
          <h1 className="practice-replace-title page-title">
            <span>换个重点</span>
            <PracticeTruckLoader />
          </h1>
