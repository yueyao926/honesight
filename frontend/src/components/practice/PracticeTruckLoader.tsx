import "./PracticeTruckLoader.css";

export default function PracticeTruckLoader() {
  return (
    <div className="practice-truck-loader" aria-hidden="true">
      <div className="practice-truck-loader__wrapper">
        <div className="practice-truck-loader__body">
        ...
        <div className="practice-truck-loader__tires">
        ...
        <div className="practice-truck-loader__road" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 453.459 453.459"
          fill="#000000"
          className="practice-truck-loader__lamp"
        >
