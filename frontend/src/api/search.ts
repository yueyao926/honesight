...
export type SearchResult={query:string;mode:string;semantic_available:boolean;users:UserSearchResult[];posts:CommunityPost[];images:CommunityPost[];tags:{id:number;name:string;slug:string;usage_count:number}[]};
