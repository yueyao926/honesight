...
from app.services.ark_vision_service import build_ai_analysis_report
...
def analyze_photo(
    ...
    report = build_ai_analysis_report(item, preference) or build_analysis_report(item, preference)
